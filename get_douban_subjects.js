...
let  movie_name_text_list =document.getElementsByClassName("movie-name-text")

let res=[]
for(let i=0;i<movie_name_text_list.length;i++){

  let  movie_name_text=  movie_name_text_list[i]
  let  a= movie_name_text.getElementsByTagName("a")[0]
//   a.href
// let movie_name=movie_name_text_list[i].innerText
