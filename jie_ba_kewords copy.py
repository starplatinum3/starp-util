...
def path_now_time(out_dir=rf"D:\i-brain\add_words",now_time_str=None):
...
col_name_list=['course_objectives','course_introduction']
...
# out_dir=os.path.join(out_dir,now_time_str)
out_dir=path_now_time(rf"D:\i-brain\add_words",now_time_str=now_time_str)
...
def file_path_to_keywords_obj(file_path=rf'D:\brain\2023_04_04_12_31_55\01 教学大纲_Python_2023_04_04_12_31_57.json',topK=20):
...
# file_path_to_keywords_obj(base_dir)
