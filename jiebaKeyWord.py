...
keywords_list=jieba.analyse.extract_tags(sentence , topK=20,withWeight=False, allowPOS=())
print("keywords_list")
print(keywords_list)
keywords = "  ".join(keywords_list)
print(keywords)

# 人工智能  智能  2017  机器  不同  人类  科学  模拟  一门  技术  计算机  研究  工作  Artificial  Intelligence  AI  图像识
# 别  12  复杂  流行语

# ['人工智能', '智能', '2017', '机器', '不同', '人类', '科学', '模拟', '一门', '技术', '计算机', '研究', '工作', 'Artifici
# al', 'Intelligence', 'AI', '图像识别', '12', '复杂', '流行语']
# 人工智能  智能  2017  机器  不同  人类  科学  模拟  一门  技术  计算机  研究  工作  Artificial  Intelligence  AI  图像识
# 别  12  复杂  流行语